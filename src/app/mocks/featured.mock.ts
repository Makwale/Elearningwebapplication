const featuredlist : course [] = [
    ...
    {
        price:955,instructor:'Sinoxolo',desc: 'We Create and Collaborate to Find the Best Solution for Our Products. Software Development built using the Agile Philosohpy.',  image: './../assets/img/featuredcourses/django.png', name: 'Django Python', gradNo: 1543, 
    },
    {
